...
pipx install speedtest-cli --spec git+https://github.com/sivel/speedtest-cli.git &
pipx install sphinx &
pipx install standardebooks --spec git+https://github.com/standardebooks/tools.git &
pipx install thefuck --spec git+https://github.com/nvbn/thefuck.git &
pipx install tox &
pipx install trash-cli --spec git+https://github.com/andreafrancia/trash-cli.git &
