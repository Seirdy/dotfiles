...
export CFLAGS="$CFLAGS -Ofast" LDFLAGS="$LDFLAGS -Ofast" CXXFLAGS="$CXXFLAGS -Ofast" CPPFLAGS="$CPPFLAGS -Ofast"
...
export CFLAGS="$CFLAGS_LTO -Ofast" \
	LDFLAGS="$CFLAGS_LTO -Ofast" \
	CXXFLAGS="$CFLAGS_LTO -Ofast" \
	CPPFLAGS="$CFLAGS_LTO -Ofast"
